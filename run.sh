...
nsight-compute-cli --target-processes all --launch-skip-before-match 0 --launch-count 1 --launch-skip-after-match 0 --section MemoryWorkloadAnalysis,SpeedOfLight -o my_profile_report ./d2q9-bgk input_2048x2048.params obstacles_2048x2048.dat
